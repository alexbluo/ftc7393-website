...
const Awards = () => {
  return (
    <div className="">
      ...
      <a className="text-3xl text-center" href="https://www.firstinspires.org/sites/default/files/uploads/resource_library/ftc/award-descriptions.pdf">Click here for Award Descriptions</a>
